...
export const PROJECTS_DATA: ProjectItem[] = [
  ...
  },
  {
    ...
    thumbnail: imgIntranetLogin,
    isFeatured: true,
    slides: [
      { src: imgIntranetLogin, alt: "로그인 페이지", tabLabel: "로그인 화면", title: "금융 업무 포털 로그인 페이지", caption: "SEIBI 2.0 업무 포털의 보안 다중 로그인 인증 및 브랜딩 가치 전달 화면" },
  ...
  },
  {
    ...
    outcome: "데스크톱 웹 서비스를 출시하고 PWA까지 확장해, 본사와 파트너사가 디바이스가 달라져도 동일한 프로젝트 맥락에서 대화·파일·업무 정보를 이어갈 수 있는 제품 경험을 마련했습니다.",
